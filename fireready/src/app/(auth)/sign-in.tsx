...
export default function SignInScreen() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      // On success the session lands in the auth store and the (auth) layout
      // redirects into the app — no navigation needed here.
    } catch (e) {
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Wildfire preparedness for your family</Text>
        </View>
